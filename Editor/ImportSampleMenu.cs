...
{
    internal static class ImportSampleMenu_SubAssetEditor
    {
        private const string k_DisplayName = "Sub Asset Editor";
        private const string k_JsonGuid = "bf13b01a38ea44465be58f8ae44ab0cf";
